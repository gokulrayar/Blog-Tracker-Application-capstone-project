...
namespace App_UI.Controllers
{
    public class BlogInfoesController : Controller
    {
        ...
        public BlogInfoesController(App_UIContext context)
        {
            _context = context;
        }
        ...
        {
            var app_UIContext = _context.BlogInfo.Include(b => b.EmpInfo);
            return View(await app_UIContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'App_UIContext.BlogInfo'  is null.");
            }
            var blogInfo = await _context.BlogInfo.FindAsync(id);
            if (blogInfo != null)
            {
